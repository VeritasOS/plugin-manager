...
func integTest(t *testing.T, pmBinary, tDir, deprecated string) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []string{
				"",
				"Checking for \"D\" settings...: " + pluginmanager.Status_Running,
				"Checking for \"D\" settings...: " + pluginmanager.Status_Succeeded,
				"",
				"Checking for \"A\" settings: " + pluginmanager.Status_Running,
				"Checking for \"A\" settings: " + pluginmanager.Status_Succeeded,
				"Running preupgrade plugins: " + pluginmanager.Status_Succeeded,
			},
			wantErr: false,
		},
		{
			...
			want: []string{
				"",
				"Checking for \"D\" settings...: " + pluginmanager.Status_Running,
				"Checking for \"D\" settings...: " + pluginmanager.Status_Failed,
				"",
				"Checking for \"A\" settings: " + pluginmanager.Status_Running,
				"Checking for \"A\" settings: " + pluginmanager.Status_Skipped,
				"Running preupgrade plugins: " + pluginmanager.Status_Failed,
				"",
			},
			wantErr: true,
		},
