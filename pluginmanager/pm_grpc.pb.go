...
func (c *pMClient) Run(ctx context.Context, in *RunRequest, opts ...grpc.CallOption) (*PluginTypeStatus, error) {
	...
	err := c.cc.Invoke(ctx, PM_Run_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPMServer must be embedded to have
...
func (UnimplementedPMServer) testEmbeddedByValue()            {}
...
func RegisterPMServer(s grpc.ServiceRegistrar, srv PMServer) {
	// If the following call pancis, it indicates UnimplementedPMServer was
